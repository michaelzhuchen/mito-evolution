...
## Write out
write.table(monophyletic_clades_filter_selected_tax_level_largest_clades_agg, file.path(out_dir, paste0("posterior_clades_HGT_", selected_tax_level, "_", OG_id, "_wide.tsv")), sep="\t", row.names=FALSE, col.names=TRUE, quote=FALSE)
