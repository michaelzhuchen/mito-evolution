...
# Specify Archaeplastida node label manually for each dataset
if (dataset_name %in% c("species_tree_1", "species_tree_2", "species_tree_6")) {
  archaeplastida_node_label <- "Node39_Archaeplastida"
} else if (dataset_name %in% c("species_tree_3", "species_tree_4")) {
  archaeplastida_node_label <- "Node40_Archaeplastida"
} else if (dataset_name %in% c("species_tree_5")) {
  archaeplastida_node_label <- "Node38_Archaeplastida"
}
...
phrogs_long_archaeplastida <- read.table(here("data", "phylogenetically_resolved_orthogroups", dataset_name, "PhROGs_long", "PhROGs_at_Node39_Archaeplastida_long.tsv"), sep="\t", header=TRUE)
